...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/04 14:38:47 by groussel          #+#    #+#             */
/*   Updated: 2018/04/07 14:54:52 by groussel         ###   ########.fr       */
=======
/*   By: oespion <oespion@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/04 12:15:47 by oespion           #+#    #+#             */
/*   Updated: 2018/04/09 14:40:16 by oespion          ###   ########.fr       */
>>>>>>> v2
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_convertbase(const char *n, const char *from,
						const char *to);
int					ft_lentill(const char *s, char c);
